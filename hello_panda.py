...
objectUid = p.loadURDF(
    os.path.join(urdfRootPath, "random_urdfs/000/000.urdf"), basePosition=[0.7, 0, 0.1]
)
...
while True:
    ...
    if current_state == 3:
        p.setJointMotorControl2(pandaUid, 1, p.POSITION_CONTROL, math.pi / 4.0 - 1)
        p.setJointMotorControl2(pandaUid, 3, p.POSITION_CONTROL, -math.pi / 2.0 - 1)
